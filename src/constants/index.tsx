export const features = [
    {
      ...
      caption: "Seamless product registration",
      title: "Effortless product verification",
      text: "With our blockchain-based verification system, product registration is quick and hassle-free. Blockchain technology ensures secure, transparent tracking, making it easier than ever to verify authenticity and combat counterfeit products.",
      button: {
    ...
    },
    {
      ...
      caption: "Transparent & immutable",
      title: "Blockchain-secured authenticity",
      text: "Your product data is stored securely on the blockchain, ensuring it’s tamper-proof and transparent. With state-of-the-art security measures, you can be confident that every product’s authenticity is verified, giving both producers and customers peace of mind.",
      button: {
  ...
  export const details = [
    { id: "0", icon: "/images/detail-1.png", title: "Seamless product registration" },
    { id: "1", icon: "/images/detail-2.png", title: "Real-time product verification" },
    { id: "2", icon: "/images/detail-3.png", title: "Blockchain-powered security" },
    { id: "3", icon: "/images/detail-4.png", title: "24/7 customer support" },
  ];
  
  export const faq = [
    { id: "0", question: "How easy is it to register a product?", answer: "Registering a product is quick and straightforward. Simply fill in the product details, and the blockchain verification is done automatically." },
    { id: "1", question: "Can I integrate this system with other platforms?", answer: "Yes, our blockchain verification system can be easily integrated with various platforms to enhance product tracking and authenticity checks." },
    { id: "2", question: "How often is the product database updated?", answer: "The product database is updated in real-time as new products are registered, ensuring up-to-date information on authenticity." },
    { id: "3", question: "Is there a fee for verifying products?", answer: "No, verifying products through the blockchain verification system is free for customers. Producers only pay for registration." },
    { id: "4", question: "Do you offer custom solutions for businesses?", answer: "Yes, we provide customized verification solutions for businesses, tailored to their specific product tracking and authentication needs." },
    { id: "5", question: "What happens if I need more product registrations?", answer: "You can easily upgrade your registration plan to accommodate more products and ensure continued seamless verification." },
    { id: "6", question: "Can I add new users to my account?", answer: "Yes, you can add new users to your account, granting them access to the product verification dashboard for smooth team collaboration." },
    { id: "7", question: "How do I track the authenticity of products?", answer: "To track authenticity, simply scan the product's QR code or use the product ID in the verification section to view all details, including blockchain-backed information." },
    { id: "8", question: "Do you provide training on using the platform?", answer: "Yes, we offer training sessions to help both individuals and businesses get the most out of the product verification system." },
    { id: "9", question: "I’m having trouble accessing my account. What do I do?", answer: "Contact our support team for assistance. We are available 24/7 to help you regain access to your account and ensure a smooth experience." },
  ];
  ...
  export const plans = [
    {
      ...
      priceMonthly: 19,
      priceYearly: 12,
      caption: "Best for small-scale producers",
      features: [
        "500MB Cloud storage",
    ...
    },
    {
      ...
      priceMonthly: 79,
      priceYearly: 59,
      caption: "Most popular plan for growing businesses",
      features: [
        "All Basic features",
        "2TB additional storage",
        "Unlimited product registrations",
        "Advanced analytics and reporting",
        "AI-powered product tracking insights",
      ],
    ...
    },
    {
      ...
      priceMonthly: 149,
      priceYearly: 99,
      caption: "Designed for large enterprises and teams",
      features: [
        "All Pro features",
        "10TB additional storage",
        "Priority customer support",
        "Real-time team collaboration",
        "AI-driven blockchain audit logs",
        "Customizable product verification workflow",
      ],
  ...
  export const testimonials = [
    {
      ...
      comment: "Using this product verification system has given us complete confidence in the authenticity of our products. The transparency is unparalleled.",
    },
    {
      id: "1",
      name: "Mark Erixon",
      ...
      comment: "I was skeptical at first about blockchain technology, but this solution has completely transformed the way we verify product authenticity.",
    },
    {
      id: "2",
      name: "Melanie Hurst",
      ...
      comment: "Adopting blockchain for product verification was straightforward, and it's made tracking product authenticity more efficient than ever.",
    },
    {
      id: "3",
      name: "Alicia Barker",
      ...
      comment: "The product verification tool has given us peace of mind, knowing our customers are receiving authentic goods backed by blockchain security.",
    },
    {
      id: "4",
      name: "Becky Snider",
      ...
      comment: "Switching to this blockchain-based verification system was the best decision for our brand. It’s made verifying product authenticity a breeze!",
    },
    {
      id: "5",
      name: "Jim Bradley",
      ...
      comment: "The ease of verifying products on the blockchain has revolutionized our process. It’s fast, secure, and completely transparent.",
    },
  ];
